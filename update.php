...
if (isset($_POST['signup_id']) &&  isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['password'])
    ...
    $sql = "UPDATE signup SET first_name = :fname, last_name = :lname, email = :email,
            password = :pass, pnum = :pnum, gender = :gender, address = :address, postal_code = :pcode 
    ...
    $_SESSION['signup_id'] = $_POST['signup_id'];
